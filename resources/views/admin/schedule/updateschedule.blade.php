...
<div class="container-fluid px-4 mt-4">
    ...
    <form action="{{route('ht.scheduleupdate',$load->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control"  value="{{old('tour_code',isset($load ->tour_code)?$load ->tour_code:null)}}" name="tour_code">
