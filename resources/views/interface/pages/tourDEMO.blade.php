                                        ...
                                        <div class="d-flex align-items-center mb-4 pt-2">
                                            ...
                                            <label for="">Children</label>
                                                ...
                                                <input type="text" name="amount1"
                                                    class="form-control bg-secondary text-center" value="0">
                                                <div class="input-group-btn">
                                                    <button class="btn btn-primary btn-plus">
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                            ...
                                            <button id="addbooking" class="btn btn-primary px-3"><i
                                                    class="fa fa-shopping-cart mr-1"></i> Book now</button>
                                        </div>
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $('#addbooking').click(function () {
                                                    ...
                                                    $.ajax({
                                                        url: "{{route('gd.addbooking', ['product_id' => ':productId', 'schedule_id' => ':scheduleId'])}}",
                                                        type: "post",
                                                        data: {
                                                        'id': productId,
                                                        'amount': amount,
